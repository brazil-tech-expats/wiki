...
* As secundarias, conhecidas como a _gama média_ e as vezes filiais das anteriores
  * [O2](https://o2online.es/). Usa tudo da Movistar mas nao tem nada de TV ou aparelhos
  * [Digi](https://www.digimobil.es/). Varias pessoas tem e nao houveram reclamaçoes
...
O sistema de saúde pública espanhol é gratuito e se pode ter acesso ao completo assim que estiver registrado na Seguridad Social.
...
Uma opção é o cinema [Babel](http://www.cinesalbatrosbabel.com). Cinema pequeno, de bairro, sem lugar marcado, porém todos os filmes são em formato original (idioma original com legendas em espanhol).
...
Seriados sao um ótimo jeito de conhecer a cultura e principalmente o idioma espanhol com seus diferentes sotaques
